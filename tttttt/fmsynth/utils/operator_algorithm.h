...
#ifndef __EXAMPLES_FMSYNTH_UTILS_OPERATOR_ALGORITHM_H
#define __EXAMPLES_FMSYNTH_UTILS_OPERATOR_ALGORITHM_H
...
#endif  /* __EXAMPLES_FMSYNTH_UTILS_OPERATOR_ALGORITHM_H */
