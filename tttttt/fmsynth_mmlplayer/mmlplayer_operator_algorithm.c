/****************************************************************************
 * apps/examples/fmsynth/utils/fmsynth_nxaudio.c
 *
...
/****************************************************************************
 * name: fmsynthmmlplayer_algorithm0
 ****************************************************************************/

FAR fmsynth_op_t *fmsynthmmlplayer_algorithm0(void)
{
  /* [Simple sin operator]
   *
   *  +--------------+
  ...
  /*
   * Attack level and period time      : 1.0, 0ms
...
/****************************************************************************
 * name: fmsynthmmlplayer_algorithm1
 ****************************************************************************/

FAR fmsynth_op_t *fmsynthmmlplayer_algorithm1(void)
{
  /*
   *        feed back
   *  +--------------------+
...
/****************************************************************************
 * name: fmsynthmmlplayer_algorithm2
 ****************************************************************************/

FAR fmsynth_op_t *fmsynthmmlplayer_algorithm2(void)
{
  /*
   *        feed back
   *  +--------------------+
...
/****************************************************************************
 * name: fmsynthmmlplayer_delete_ops
 ****************************************************************************/

void FAR fmsynthmmlplayer_delete_ops(FAR fmsynth_op_t *op)
{
  ...
  while (op)
    {
      ...
      if (op->cascadeop)
        {
          fmsynthmmlplayer_delete_ops(op->cascadeop);
        }
