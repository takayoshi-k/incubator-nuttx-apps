/****************************************************************************
 * apps/examples/fmsynth/utils/music_scale.h
 *
...
#ifndef __EXAMPLES_FMSYNTH_MMLPLAYER_MUSIC_SCALE_H
#define __EXAMPLES_FMSYNTH_MMLPLAYER_MUSIC_SCALE_H
...
static const float fmsynthmmlplayer_scale[] =
{
  /* Octave 0 */
...
#define MAX_SCALE \
    (sizeof(fmsynthmmlplayer_scale) / sizeof(fmsynthmmlplayer_scale[0]))

#endif /* __EXAMPLES_FMSYNTH_MMLPLAYER_MUSIC_SCALE_H */
